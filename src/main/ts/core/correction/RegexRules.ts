...
export let autocorrectRegexRules: RegexRule[] = [
    ...
    },
    {
        ...
        description: 'Použijte nerozdělitelnou mezeru',
        correctionLabel: 'Opravte obyčejnou mezeru na nezlomitelnou (za předložkou, zkratkou, …)',
        about:[{
            url: 'IJP',
    ...
    },
    {
        ...
        correctionLabel: 'Změňte běžnou mezislovní mezeru na nerozdělitelnou',
