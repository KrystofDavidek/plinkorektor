...
export const mezery: string =
  '[\u{0020}\u{00A0}\u{1680}\u{2001}\u{2002}\u{2003}\u{2004}\u{2005}\u{2006}\u{2007}\u{2008}\u{2009}\u{200A}\u{202F}\u{205F}\u{3000}]';
...
export const interpunkce: string =
  '[\\.,;:!\\?\u{2013}\u{2014}\u{2026}\u{0028}\u{0029}\u{005B}\u{005D}\u{007B}\u{007D}\00AB\u{00BB}\u{201E}\u{201C}\u{201A}\u{2018}]';
...
export const zacatek_slova: string =
  '[\u{0020}\u{00A0}\u{1680}\u{2001}\u{2002}\u{2003}\u{2004}\u{2005}\u{2006}\u{2007}\u{2008}\u{2009}\u{200A}\u{202F}\u{205F}\u{3000}\u{0028}\u{005B}\u{007B}\u{00AB}\u{201A}\u{201E}]';
export const konec_slova: string =
  '[\u{0020}\u{00A0}\u{1680}\u{2001}\u{2002}\u{2003}\u{2004}\u{2005}\u{2006}\u{2007}\u{2008}\u{2009}\u{200A}\u{202F}\u{205F}\u{3000}\u{0029}\u{005D}\u{007D}\u{00BB}\u{2018}\u{201C}]';
...
export let highlightRegexRules: RegexRule[] = [
  ...
  },
  {
    ...
    search: new RegExp(
      '([' +
        ...
        ']+)-([' +
        pismena +
        ']+)([(ý)(ého)(ému)(ého)(ém)(ým)(á)(é)(ou)(í)(ých)(ým)(ými)(ího)(ímu)(ím)(ích)(ími)(ě)(e)])',
      'g',
    ),
    replace: '$1$2$3',
  },
  ...
  },
  {
    ...
    search: new RegExp(
      '([^' + cislice + '][12]' + cislice + '{3})\u0020–\u{0020}([12]' + cislice + '{3}[^' + cislice + '])',
      'g',
    ),
    replace: '$1–$2',
  },
